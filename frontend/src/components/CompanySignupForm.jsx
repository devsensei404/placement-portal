...
export default function CompanySignupForm({ onBack, onSuccess }) {
  ...
  return (
    <div className="kg-form-panel">
      ...
      <div className="kg-form-header">
        ...
        <h1 className="kg-heading">Company account</h1>
        <p className="kg-subtext">You'll complete your company profile after signing up.</p>
      </div>
